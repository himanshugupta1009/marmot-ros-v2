...
class StateUpdater:
    ...
    def update_state(self, req):
        ...
        if self.record_hist == False and self.saved_hist == False and len(self.hist_veh_pose_msg) > 0: 
            self.save_s_hist()

        current_state = [0]*(4 + 2*(4))
        peds_in_env = [False]*4
    ...
    def save_s_hist(self):
        ...
        print("record_hist:", self.record_hist)
        print("saved_hist:", self.saved_hist)
        print("len(hist_veh_pose_msg):", len(self.hist_veh_pose_msg))   
